...
import { LayoutDashboard, Library, Briefcase, Bot, Settings, Bell, Menu, X, AlertTriangle, Lightbulb, Search, MessageSquare, Wand2, CheckCircle2, CalendarX, ShieldAlert, Megaphone } from "lucide-react";
...
function NavLinks({ location, gateCount, onNavigate }: { location: string; gateCount: number; onNavigate?: () => void }) {
  ...
  const aiItems = [
    ...
    { href: "/brief", label: "Marketing Brief", icon: Megaphone, badge: 0 },
  ];
